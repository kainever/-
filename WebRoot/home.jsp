...
<div class="container">
    <div class="header clearfix">
        ...
        <h3 class="text-muted"><a href="#"> 留言板 </a></h3>
    </div>
            ...
            <div>
                <form role="form" action="#">
                    <div class="form-group">
                        <textarea class="form-control" rows="3" placeholder="今天遇到什么新鲜事，赶紧来吐槽下吧"
            ...
            <div class="recentMsg">
                ...
                <div class="allComment">
                    <div style="background-color: azure">
                        ...
                        <a href="javascript:void(0)" class="col-lg-offset-2">赞(1)</a>
                        <a href="javascript:void(0)" class="col-lg-offset-2">收藏</a>
                    </div>
                    <div class="allComment">
                        <ul class="list-group">
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <p>
                                            <time>6:25</time>
                                            <a href="javascript:void(0)" class="col-lg-offset-2 comment">回复</a></p>
                                    </div>
                                </div>
                                <ul class="list-group">
                                    <li class="list-group-item">
                ...
                <div class="commentFrame" style="display: none">
                    <form role="form" action="ajax">
                        ...
                        <input type="submit" class="btn btn-primary col-lg-offset-10 submitComment" value="发表"
                               />
                    </form>
                </div>
